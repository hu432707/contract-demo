...
contract Staker is ReentrancyGuard {
    ...
    // 1.1 => 11000
    uint256 public interestMultiplierPoints;
    ...
    constructor(
        ...
        interestMultiplierPoints = interestMultiplierPoints_;
    }
    ...
    function _claimableReward(
        ...
        uint256 interestMultiplierPoints_ = interestMultiplierPoints;
        for (uint i = 0; i < cycle; ) {
            totalReward =
